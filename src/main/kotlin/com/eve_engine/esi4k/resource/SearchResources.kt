...
import com.eve_engine.esi4k.model.SearchResult

class SearchResources (client: ESIClient,  datasource: Datasource = Datasource.TRANQUILITY): ESIResources(client,  datasource) {
